...
#include <memory>
#include "../../includes/cameracapture.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CameraCapture_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CameraCapture_t qt_meta_stringdata_CameraCapture = {
    {
        QT_MOC_LITERAL(0, 13),  // "CameraCapture"
        QT_MOC_LITERAL(14, 12),  // "frameCapture"
        QT_MOC_LITERAL(27, 0),  // ""
        QT_MOC_LITERAL(28, 7),  // "cv::Mat"
        QT_MOC_LITERAL(36, 6),  // "_frame"
        QT_MOC_LITERAL(43, 15)   // "captureContinue"
    },
    "CameraCapture",
    "frameCapture",
    "",
...
Q_CONSTINIT static const uint qt_meta_data_CameraCapture[] = {
...
Q_CONSTINIT const QMetaObject CameraCapture::staticMetaObject = { {
    ...
    qt_meta_stringdata_CameraCapture.offsetsAndSizes,
...
void CameraCapture::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->frameCapture((*reinterpret_cast< std::add_pointer_t<cv::Mat>>(_a[1]))); break;
        case 1: _t->captureContinue(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &CameraCapture::frameCapture; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void CameraCapture::frameCapture(cv::Mat _t1)
{
