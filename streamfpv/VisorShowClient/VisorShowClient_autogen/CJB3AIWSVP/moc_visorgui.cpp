...
Q_CONSTINIT static const qt_meta_stringdata_VisorGUI_t qt_meta_stringdata_VisorGUI = {
    {
        ...
        QT_MOC_LITERAL(9, 16),  // "displayImageData"
        QT_MOC_LITERAL(26, 0),  // ""
        QT_MOC_LITERAL(27, 7),  // "cv::Mat"
        QT_MOC_LITERAL(35, 12),  // "switchLayout"
        QT_MOC_LITERAL(48, 24),  // "onNetworkListItemClicked"
...
void VisorGUI::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->displayImageData((*reinterpret_cast< std::add_pointer_t<cv::Mat>>(_a[1]))); break;
        case 1: _t->switchLayout(); break;
        case 2: _t->onNetworkListItemClicked((*reinterpret_cast< std::add_pointer_t<QListWidgetItem*>>(_a[1]))); break;
        default: ;
        }
    }
}
